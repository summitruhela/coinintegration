...
const client = new Client(Config.get('aidos.testnet'));
/**
...
exports.getNewAddress = function (req, res) {
    ...
    client.getNewAddress(account, (err, result) => {
        if (err) {
...
exports.listAccounts = function (req, res) {
    ...
    client.listAccounts((err, result) => {
        if (err) {
            return console.error(err);
        }
        res.json({
...
exports.getBalance = function (req, res) {
    ...
    var account = req.params.account;
    client.getBalance(account, (err, result) => {
        if (err) {
            return res.json({
                err: err
            });
...
exports.validateAddress = function (req, res) {
    ...
    client.validateAddress(address, (err, result) => {
        if (err) {
            return console.error(err);
        }
        res.json({
...
exports.listAddressGroupings = function (req, res) {
    var address = req.params.address;
    client.listAddressGroupings((err, result) => {
        if (err) {
            return console.error(err);
        }
        res.json({
...
exports.sendToAddress = function (req, res) {
    ...
    client.sendToAddress(toAddress, amount, (err, result) => {
        if (err) {
            return console.error(err);
        }
        res.json({
...
exports.setTxFee = function (req, res) {
    console.log("SET-TX-FEE")
    var amount = req.body.amount;
    client.setTxFee(amount, (err, address) => {
        if (err) {
            return console.error(err);
        }
        res.json({
...
exports.getReceivedByAccount = function (req, res) {
    var address = req.params.address;
    client.listAccounts(function (err, deposits) {
        if (err) {
...
exports.listTx=(req,res)=>{
    var account = req.params.account;
    client.listTransactions(account, (err, result) => {
        if (err) {
            return console.error(err);
        }
        res.json({
